...
chcp 65001 >nul
REM ============================================================
REM SpatchEx -- Environment Setup Logic
REM scripts\setup_env.bat
REM
REM  Called by install.bat (project root).
REM  Do NOT run this file directly -- run install.bat instead.
REM
REM  Steps:
...
REM ── Change to project root (scripts\ -> parent) ──────────────
cd /d "%~dp0.."
